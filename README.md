...
Live site: [library.surge.sh](http://library.surge.sh)

Sample app built using [Ampersand.js](http://ampersandjs.com/) using [React](http://facebook.github.io/react/) as a view layer.

It's compiled into a completely static site and deployed to [library.surge.sh](http://library.surge.sh) staticly using [Surge.sh](http://surge.sh/).
